 ...
 * @author kcsolutions
 */
public class MEstadoReserva extends javax.swing.JFrame {

    /**
     * Creates new form MEstadoReserva
     */
    public MEstadoReserva() {
        initComponents();
    ...
    private void idKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_idKeyReleased
        if(id.getText().equals("")==false){
            ...
            String consulta=usuario.validarID("EstadoReservas.txt", id.getText());
            if(consulta.equals("no")){
                estado.setSelected(false);
                mensaje.setText("CREANDO");
            }else{
                estado.setSelected(Boolean.valueOf(consulta.split("~")[1]));
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        if(id.getText().equals("")==false){
            ...
            String validar=general.validarID("EstadoReservas.txt",id.getText());
            if(validar.equals("no")){
                general.registrar("EstadoReservas.txt",id.getText()+"~"+estado.isSelected());

                estado.setSelected(false);
                mensaje.setText("CREANDO");

            }else{
                general.modificar("EstadoReservas.txt",id.getText(),id.getText()+"~"+estado.isSelected());
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        if(id.getText().equals("")==false){
            ...
            String consulta=borrar.validarID("EstadoReservas.txt", id.getText());
            if(consulta.equals("no")){
                JOptionPane.showMessageDialog(null,"El id no existe","Error",JOptionPane.ERROR_MESSAGE);
            }else{
                borrar.eliminar("EstadoReservas.txt", id.getText());
                id.setText("");
                estado.setSelected(false);
                mensaje.setText("CREANDO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MEstadoReserva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MEstadoReserva().setVisible(true);
            }
        });
    }

 ...
 * @author kcsolutions
 */
public class CCuotaCliente extends javax.swing.JFrame {

    /**
     * Creates new form CCuotaCliente
     */
    public CCuotaCliente() {
        initComponents();
                llenarTabla();
    ...
    private void initComponents() {
        ...
        cuotaCliente = new javax.swing.JTable();
        ...
        jLabel1.setText("CONSULTA CUOTA CLIENTE");
        ...
        cuotaCliente.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cuotaCliente.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "Fecha", "Cliente", "Valor Cobro", "Estado"
            }
        ) {
        ...
        jScrollPane1.setViewportView(cuotaCliente);
    ...
    MetodosGenerales datosTabla = new MetodosGenerales();
       ...
       DefaultTableModel  modelo =(DefaultTableModel) cuotaCliente.getModel();
         modelo.setRowCount(0);
         cuotaCliente.setModel(modelo);
    ...
    private void buscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscarMouseClicked
        ...
        vector=datosTabla.LlenarTablaCondicion("EncabezadoCuotas.txt",2,cliente.getText());
        String datos [ ] = new String [5];
        for (int i = 0; i <vector.size(); i++) {
            datos[0]=vector.get(i).toString().split("~")[0];
            datos[1]=vector.get(i).toString().split("~")[1];
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CCuotaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CCuotaCliente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable cuotaCliente;

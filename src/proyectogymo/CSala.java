 ...
 * @author kcsolutions
 */
public class CSala extends javax.swing.JFrame {

    /**
     * Creates new form CSala
     */
    public CSala() {
        initComponents();
         MetodosGenerales datosTabla = new MetodosGenerales();
       ArrayList vector = new ArrayList();
       DefaultTableModel  modelo =(DefaultTableModel) sala.getModel();
         modelo.setRowCount(0);
         sala.setModel(modelo);

         vector=datosTabla.LlenarTabla("Salas.txt");
    ...
    private void initComponents() {
        ...
        sala.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(sala);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSala.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable sala;

 ...
 * @author kcsolutions
 */
public class CActividad extends javax.swing.JFrame {

    /**
     * Creates new form CActividad
     */
    public CActividad() {
        initComponents();
       ...
       DefaultTableModel  modelo =(DefaultTableModel) actividad.getModel();
         ...
         vector=datosTabla.LlenarTabla("Actividades.txt");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTA ACTIVIDADES");
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CActividad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CActividad().setVisible(true);
            }
        });
    }
